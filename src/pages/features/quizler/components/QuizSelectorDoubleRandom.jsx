...
const QuizSelectorDoubleRandom = ({ onQuizFetched }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography>
          Seviye ,her seviyeden gelicek şekilde ayarlandı. Her quizde kategori
          rastgele belirlenir, bu sayede farklı konuları öğrenmiş olursun.
        </Typography>
...
export default QuizSelectorDoubleRandom;
