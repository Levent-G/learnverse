...
export const BearWithArms = ({ size = 60, expression = "neutral" }) => {
  ...
  return (
    ...
    >
      ...
      {/* Ağız */}
      {isHappy && (
        <path d="M38 65 Q50 75 62 65" stroke="#000" strokeWidth="2" fill="none" />
      )}
      {isSad && (
        <path d="M38 75 Q50 65 62 75" stroke="#000" strokeWidth="2" fill="none" />
      )}
      {!isHappy && !isSad && (
