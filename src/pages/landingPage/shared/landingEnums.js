...
export const features = [
  {
    ...
    bgLightColor: "#bfdbfe", // bg-blue-100
    textLightColor: "#1e3a8a", // text-blue-900
    bgDarkColor: "#1e3a8a", // bg-blue-900
    textDarkColor: "#bfdbfe", // text-blue-200
  },
  {
    ...
    bgLightColor: "#d1fae5", // bg-green-100
    textLightColor: "#065f46", // text-green-900
    bgDarkColor: "#065f46", // bg-green-900
    textDarkColor: "#d1fae5", // text-green-200
  },
  {
    ...
    bgLightColor: "#fef3c7", // bg-yellow-100
    textLightColor: "#78350f", // text-yellow-900
    bgDarkColor: "#78350f", // bg-yellow-900
    textDarkColor: "#fef3c7", // text-yellow-200
  },
  {
    ...
    bgLightColor: "#ede9fe", // bg-purple-100
    textLightColor: "#5b21b6", // text-purple-900
    bgDarkColor: "#5b21b6", // bg-purple-900
    textDarkColor: "#ede9fe", // text-purple-200
  },
  {
    title: "Tema Seçimi",
    ...
    bgLightColor: "#fce7f3", // bg-pink-100
    textLightColor: "#831843", // text-pink-900
    bgDarkColor: "#831843", // bg-pink-900
    textDarkColor: "#fce7f3", // text-pink-200
  },
  {
    ...
    bgLightColor: "#ccfbf1", // bg-teal-100
    textLightColor: "#134e4a", // text-teal-900
    bgDarkColor: "#134e4a", // bg-teal-900
    textDarkColor: "#ccfbf1", // text-teal-200
  },
];

export const generalAnalyses = [
  [
